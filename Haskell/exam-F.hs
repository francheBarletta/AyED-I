...
sumarVagon :: Vagon -> Int -> Vagon
sumarVagon (Minerales mineral capacidad cantidad) extra = Minerales mineral capacidad (cantidad + extra)
sumarVagon cisterna@(Cisterna _ _ _) _ = cisterna
